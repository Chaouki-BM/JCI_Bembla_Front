...
const FerstPage = ({navigation}) => {
  ...
  return (
   ...
   <ImageBackground source={require("../assets/backgroundFirstPage.png")} resizeMode='cover'
    style={{ width:width,height:height,}} >
      ...
      <TouchableOpacity onPress={nextscreen} style={{position: 'absolute',top:(height/1.15)
  ...
  ,marginStart:width*0.06,marginEnd:width*0.03,marginTop:height*0.015,marginBottom:height*0.015,}}>التالي
  </Text>
  <IcSimpleLineIconson name="arrow-right-circle" color="#FFFFFF"  size={height*0.034} style={{alignSelf:"center",marginEnd:width*0.03}}/>
</TouchableOpacity>
</View>
      <View style={{marginHorizontal:width*0.05,marginVertical:height*0.42}}> 
   <Text style={{fontWeight:'bold' ,fontSize:width*0.05,color:'#1596D0',}}>ميثــاق الغرفــة الفتيــة
</Text>
<Text style={{fontWeight:'200' ,fontSize:width*0.05,color:'#1596D0',}}>نحــن نعتقــد :</Text>
<Text style={{fontWeight:'200' ,fontSize:width*0.05,color:'#1596D0',}}>
